...
public class FireworkEffectPlayer {
	...
	public void playFirework(World world, Location loc, FireworkEffect fe) throws Exception {
		...
		/*
		 * The reflection part, this gives us access to funky ways of messing around
		 * with things
		 */
		...
		/*
		 * Now we mess with the metadata, allowing nice clean spawning of a pretty
		 * firework (look, pretty lights!)
		 */
		// metadata load
